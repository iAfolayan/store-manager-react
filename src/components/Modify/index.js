...
class Modify extends Component {
  ...
  render() {
    ...
    return (
      <Fragment>
        <h5 className="ml-3 text-primary">Modify Product</h5>
        <hr className="mr-5" />
        <div className="col-md-6 formWrapper">
          <form onSubmit={this.handleSubmit}>
            <InputForm text="Name" error={errors.name} label="productName" type="text" name="productName" id="productName" value="blueetooth" placeholder="Name" onChange={this.handleChange} />
            ...
            <div className="form-group">
              ...
              <textarea className="form-control" name="description" id="description" placeholder="Description" onChange={this.handleChange}>New technology </textarea>
            ...
            <div className="form-group">
              ...
              <small id="productHelp" className="form-text text-muted">Change product Image</small>
              <span className="text-danger">{errors.image}</span>
            </div>
            <button className="btn btn-outline-primary float-right">{ isLoading ? 'Update product' : 'Loading...'}</button>
          </form>
        </div>
        </Fragment>
    );
